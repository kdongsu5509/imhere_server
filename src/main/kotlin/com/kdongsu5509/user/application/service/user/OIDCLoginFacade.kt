...
import com.kdongsu5509.user.application.port.out.user.oauth.OIDCVerificationPort
...
class OIDCLoginFacade(
    ...
    private fun convertToAuthenticationResult(user: User): AuthenticationProcessResult {
        ...
        val jwtToken = jwtTokenProvider.issueJwtToken(ImHereJwtTokenElements.from(user))
