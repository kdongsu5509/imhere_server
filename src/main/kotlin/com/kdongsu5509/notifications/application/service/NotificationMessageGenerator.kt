...
object NotificationMessageGenerator {
    ...
    fun getMessageTitle(type: NotificationType): String {
        return when (type) {
            ...
            NotificationType.ARRIVAL, NotificationType.ARRIVAL_CONFIRMATION -> "목적지 도착 안내"
    ...
    fun getMessageBody(type: NotificationType, senderNickname: String): String {
        return when (type) {
            ...
            NotificationType.ARRIVAL, NotificationType.ARRIVAL_CONFIRMATION -> "${senderNickname}님이 목적지에 도착했습니다."
