...
object NotificationMessageGenerator {
    ...
    fun getMessageTitle(type: NotificationType): String {
        return when (type) {
            ...
            NotificationType.LOCATION_SHARE_RECEIVED, NotificationType.LOCATION_TARGET -> "위치 공유 알림"
    ...
    fun getMessageBody(type: NotificationType, senderNickname: String): String {
        return when (type) {
            ...
            NotificationType.LOCATION_SHARE_RECEIVED, NotificationType.LOCATION_TARGET -> "${senderNickname}님이 위치를 공유했습니다."
